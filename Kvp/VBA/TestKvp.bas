...
Private Sub Cohorts_AllAandBOnly()
    ...
    myCohortKeys = myResult.GetItem(VBAExtensions.Cohort_AllAandBOnly).GetKeys
...
Private Sub Cohorts_AandBDifferentValues()
    ...
    Dim myCohortKeys As Variant
    myCohortKeys = myResult.GetItem(VBAExtensions.Cohort_AandBDifferentValues).GetKeys
...
Private Sub Cohorts_InAorInB()
    ...
    Set myResult = myKvp1.Cohorts(myKvp2)
    myCohortKeys = myResult.GetItem(VBAExtensions.Cohort_InAorInB).GetKeys
...
Private Sub Cohorts__AandBSameValue()
    ...
    Set myResult = myKvp1.Cohorts(myKvp2)
    myCohortKeys = myResult.GetItem(VBAExtensions.Cohort_AandBSameValues).GetKeys
...
Private Sub Cohorts__Aonly()
    ...
    Set myResult = myKvp1.Cohorts(myKvp2)
    myCohortKeys = myResult.GetItem(VBAExtensions.Cohort_Aonly).GetKeys
...
Private Sub Cohorts_Bonly()
    ...
    Set myResult = myKvp1.Cohorts(myKvp2)
    myCohortKeys = myResult.GetItem(VBAExtensions.Cohort_Bonly).GetKeys
